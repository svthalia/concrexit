...
class Shift(models.Model):
    ...
    start = models.DateTimeField(
        ...
        null=False,
        help_text=_(
            "The end time is only indicative and does not prevent orders being created after the shift has ended. This only happens after locking the shift. For self-order shifts, the end time applies to self-ordering, but changes can still be made by managers."
        ),
    )
    ...
    is_selforder = models.BooleanField(
        verbose_name=_("is self-order"),
        default=False,
        help_text=_("Indicates whether this shift allows self-ordering by members."),
    )
