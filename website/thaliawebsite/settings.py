...
MONEYBIRD_MEMBER_PK_CUSTOM_FIELD_ID = os.environ.get("MONEYBIRD_CUSTOM_FIELD_ID", None)
MONEYBIRD_UNKOWN_PAYER_CONTACT_ID = os.environ.get("MONEYBIRD_UNKOWN_PAYER_ID", None)
MONEYBIRD_CONTRIBUTION_LEDGER_ID = os.environ.get(
    "MONEYBIRD_CONTRIBUTION_LEDGER_ID", None
)

MONEYBIRD_THALIAPAY_FINANCIAL_ACCOUNT_ID = os.environ.get(
    "MONEYBIRD_THALIAPAY_FINANCIAL_ACCOUNT_ID", None
)
MONEYBIRD_CASH_FINANCIAL_ACCOUNT_ID = os.environ.get(
    "MONEYBIRD_CASH_FINANCIAL_ACCOUNT_ID", None
)
MONEYBIRD_PIN_FINANCIAL_ACCOUNT_ID = os.environ.get(
    "MONEYBIRD_PIN_FINANCIAL_ACCOUNT_ID", None
)
