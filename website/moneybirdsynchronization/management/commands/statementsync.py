...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        card_account_id = apiservices.get_financial_account_id(
            payment_identifiers[Payment.CARD]
        )
        apiservices.link_transaction_to_financial_account(
            card_account_id, new_card_payments
        )

        cash_account_id = apiservices.get_financial_account_id(
            payment_identifiers[Payment.CASH]
        )
        apiservices.link_transaction_to_financial_account(
