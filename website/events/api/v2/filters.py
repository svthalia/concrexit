        ...
        return [
            {
                ...
                'required': False,
                'in': 'query',
                'description': 'Filter events by ISO date, starting with this parameter (i.e. 2021-03-30T04:20:00)',
                'schema': {
                    'type': 'string',
                },
            },
            {
                ...
                'required': False,
                'in': 'query',
                'description': 'Filter events by ISO date, ending with this parameter (i.e. 2021-05-16T13:37:00)',
                'schema': {
                    'type': 'string',
                },
            },
