# Generated by Django 4.0.7 on 2022-10-16 21:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='photo',
            name='face_recognition_processed',
            field=models.BooleanField(default=False, verbose_name='face encodings processed'),
        ),
        migrations.AlterField(
            model_name='like',
            name='member',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.member', verbose_name='Member'),
        ),
        migrations.AlterField(
            model_name='like',
            name='photo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='likes', to='photos.photo', verbose_name='Photo'),
        ),
        migrations.CreateModel(
            name='ReferenceFace',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.ImageField(upload_to=photos.models.reference_face_uploadto, verbose_name='file')),
                ('encoding', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reference_face', to='photos.faceencoding')),
                ('matches', models.ManyToManyField(related_name='matches', to='photos.faceencoding')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reference_faces', to='members.member', verbose_name='Member')),
            ],
        ),
        migrations.AddField(
            model_name='faceencoding',
            name='photo',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='face_encodings', to='photos.photo', verbose_name='Photo'),
        ),
    ]
